          ...
          <a href="${o.largeImageURL}">
            ...
            <div class="img-desc">
              ...
              <span><b>Downloads:</b> <br/>${o.downloads}</span>
                  ...
                  `);c.insertAdjacentHTML("afterbegin",n.join("")),u.style.display="none",b.refresh(),i="",l.reset()}).catch(t=>{console.error("Error:",t)})});const b=new m(".gallery a",{overlayOpacity:0,captionsData:"alt",captionDelay:250});
